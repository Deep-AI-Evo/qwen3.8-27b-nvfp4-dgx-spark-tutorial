...
| 上下文 | DGX Spark NVFP4（本仓库） | PRO 5000 FP8（无 MTP） | PRO 5000 Q6_K | **PRO 6000 FP8+MTP** | **PRO 6000 FP8 无 MTP** | PRO 6000 NVFP4+MTP | PRO 6000 NVFP4 无 MTP | PRO 6000 Q6_K |
|---|---|---|---|---|---|---|---|---|
...
- **长上下文 decode 之王**：PRO 5000 的 NVFP4+MTP（n=1, marlin）57.8 t/s @148K 为三设备实测最高；
  注意 MTP 长上下文收益因后端/n 值而反转（PRO 6000 的 n=2 配置在 200K 崩盘，关 MTP 才有 43.7 t/s），
  用前实测自己的配置
